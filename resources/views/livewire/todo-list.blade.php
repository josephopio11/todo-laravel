            ...
            <div wire:key='{{ $todo->id }}'
                ...
                <div class="flex justify-between space-x-2">
                    ...
                    <div class="flex">
                        ...
                        @else
                            @if ($todo->completed)
                                <h3 class="text-lg text-semibold text-gray-800 strike-through">
                                    <s>{{ $todo->name }}</s>
                                </h3>
                            @else
                                <h3 class="text-lg text-semibold text-gray-800 strike-through">{{ $todo->name }}</h3>
                            @endif
                        @endif
                    </div>
                ...
                <div class="flex justify-between">
                    ...
                    @if (session('updated' . $todo->id))
                        <span class="text-purple-500 text-xs">{{ session('updated' . $todo->id) }}</span>
                    @endif
                </div>
